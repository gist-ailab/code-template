...
python tools/lazyconfig_train_net.py --config-file base_configs/Misc/torchvision_imagenet_R_50.py \
...
"""
Note: Here we put reusable code (models, evaluation, data) together with base_configs just as a
proof-of-concept, to easily demonstrate what's needed to train a ImageNet classifier in detectron2.
Writing code in base_configs offers extreme flexibility but is often not a good engineering practice.
